...
const QuotationCart = ({ selectedProducts, onRemoveItem }) => {
  ...
  useEffect(() => {
    ...
    if (selectedProducts.length > 0 && !isOpen) {
      // Pulse animation for the cart button when new items are added
      setIsAnimating(true);
  ...
  return (
    <>
      ...
      >
        {/* Cart Header */}
        <div className="bg-sky-600 text-white p-4 flex justify-between items-center sticky top-0 z-10">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4">
          ...
          <button
            className="w-full bg-sky-600 text-white py-3 rounded-lg hover:bg-sky-700 transition-colors duration-200 flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
